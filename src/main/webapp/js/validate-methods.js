...
$(function(){
	...
	//检测虚拟福利数量 
	jQuery.validator.addMethod("isVirtual", function(value, element) { 
		var virtual = value;  
		var welfareNum = $("#welfareNum").val();
		return this.optional(element) || (parseInt(virtual)<parseInt(welfareNum));    
	}, "不能大于等于福利数量");
