var shareUserId, shareLink, time_now,time_distance_start, _FULItimer,  useAdminId;
	...
	$(function() {
		sessionStorage.setItem("loginuser",JSON.stringify(user));
 		...
 		shareLink =   manageServerName+"/view/php/reciblerUrlPhp?wid="+ welfareId +"&shareUserId=" +user.id+ "&adminId=" +user.adminId ;
 		if(user.adminId==31){
		...
		//scalePage2(); //**影响详情页适配手机 2019-1-17*/    
...
function toCompanyDetail(id){ 
	window.location.href = ctx + "/manage/web/tocompanyInfo?companyId="+id+"&adminId="+useAdminId; 
}
...
function toPhpMy(){
	...
	window.location.href=ctx+"/view/main/main?adminId="+user.adminId+"&type=3"
