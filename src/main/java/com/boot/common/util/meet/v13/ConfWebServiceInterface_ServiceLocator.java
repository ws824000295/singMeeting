...
public class ConfWebServiceInterface_ServiceLocator extends org.apache.axis.client.Service implements  com.boot.common.util.meet.v13.ConfWebServiceInterface_Service {
...
//    	ConfWebServiceInterface_address = ConfigUtil.getConfig("url");
    ...
    public  com.boot.common.util.meet.v13.ConfWebServiceInterfacePortType getConfWebServiceInterface() throws javax.xml.rpc.ServiceException {
    ...
    public  com.boot.common.util.meet.v13.ConfWebServiceInterfacePortType getConfWebServiceInterface(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	 com.boot.common.util.meet.v13.ConfWebServiceInterfaceStub _stub = new  com.boot.common.util.meet.v13.ConfWebServiceInterfaceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if ( com.boot.common.util.meet.v13.ConfWebServiceInterfacePortType.class.isAssignableFrom(serviceEndpointInterface)) {
            	 com.boot.common.util.meet.v13.ConfWebServiceInterfaceStub _stub = new  com.boot.common.util.meet.v13.ConfWebServiceInterfaceStub(new java.net.URL(ConfWebServiceInterface_address), this);
                _stub.setPortName(getConfWebServiceInterfaceWSDDServiceName());
                return _stub;
            }
        }
...
//            ports.add(new javax.xml.namespace.QName(ConfigUtil.getConfig("wsdlUrl"), "ConfWebServiceInterface"));
