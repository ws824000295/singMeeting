...
//	 String ip = "	27.184.139.0";
//	 String back = "";
//	 try {
//		 back = addressUtils.getAddresses("ip="+ip, "utf-8");
//		 Map<String, Object> js = new Gson().fromJson(back, Map.class);
//		 js = (Map<String, Object>) js.get("data");
//		 System.out.println(js.get("city").toString());
